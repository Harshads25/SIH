...
def fetch_weather_data():
    url = ('https://archive-api.open-meteo.com/v1/archive?latitude=21.1463&longitude=79.0849&start_date=2024-05-01&end_date=2024-09-04&hourly=temperature_2m,relative_humidity_2m,rain,soil_temperature_0_to_7cm&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=auto')
